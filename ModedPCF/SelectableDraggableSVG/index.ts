...
export class SelectableDraggableSVG implements ComponentFramework.StandardControl<IInputs, IOutputs> {
	...
	private _useFillSelectedItems: boolean;
	private _fillSelectedItems: string;
	...
	*/
	...
	public updateView(context: ComponentFramework.Context<IInputs>): void {
		...
		// Set Selected items
		if (this.contextObj.parameters.selectedItems.raw != null) {
			this._SelectedItems = this.contextObj.parameters.selectedItems.raw;
		}
		// Set use Fill Selected Items 
		if (this.contextObj.parameters.useFillselectedItems != null) {
			this._useFillSelectedItems = (this.contextObj.parameters.useFillselectedItems.raw != 'no');
		}
		// Set Selected items Fill
		if (this.contextObj.parameters.fillSelectedItems.raw != null) {
			this._fillSelectedItems = this.contextObj.parameters.fillSelectedItems.raw;
		}
